import{F as Gt,G as It,H as Mt,J as Nt,e as Ht,s as de,a as Ot,o as Rt,k as P,K as Ut,y as qt,f as Ee,I as d,n as r,i as S,l as e,q as ce,r as he,z as at,b as p,d as Vt,B as k,C as a,D as q,t as w,x as i,u as V,A as m,$ as Bt,v as Fe,L as st,m as Kt,w as rt}from"./index-BFNsnWIn.js";import{b as Zt,S as Jt}from"./SkeletonLoader-BJDm8Vni.js";function Wt(v,Q,A){Gt(()=>{var $=It(()=>Q(v,A==null?void 0:A())||{});if($!=null&&$.destroy)return()=>$.destroy()})}function lt(v){try{return new Date(v).toLocaleDateString("es-CO",{year:"numeric",month:"long",day:"numeric"})}catch{return v}}function Yt(v){return`
  <div class="header">
